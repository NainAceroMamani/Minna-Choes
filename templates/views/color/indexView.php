              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php foreach($data as $color) : ?>
                    <tr>
                        ...
                        <td>
                          <a href="color?action=2&id=<?php echo $color["id"] ?>"><button class="btn btn-primary"><i class="fas fa-wrench"></i></button></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                <?php endif; ?>
          ...
          <div class="card">
            ...
            <form method="POST">
              <div class="form-group">
                ...
                <small id="emailHelp" class="form-text text-muted">Ingrese un nombre que no exita para el color</small>
              </div>
              <div class="form-group">
                <label for="description">Descripción para el Color</label>
              ...
              <a href="color" class="btn btn-dark">Cancelar</a>
